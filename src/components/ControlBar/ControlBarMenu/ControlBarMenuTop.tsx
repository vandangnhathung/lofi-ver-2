            ...
            <div className="w-[35%]">
                <div className={`flex gap-3 flex-col h-full`}>
                    ...
                    <button
                        ...
                        <div
                            className={`w-[30px] ta-center transition-all duration-500 group-hover:grayscale-0 grayscale aspect-square before:content-normal before:absolute before:inset-0 before:rounded-full before:bg-black before:opacity-10 relative`}>
