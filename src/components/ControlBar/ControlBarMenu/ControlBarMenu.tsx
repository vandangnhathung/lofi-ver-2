...
const ControlBarMenu = () => {
    ...
    return (
        <div
            className={`${controlBar ? "close-effect" : "open-effect"} transition-all slow-effect-duration fixed z-20 top-gap-container capitalize left-gap-container font-medium`}
        >
            <div
